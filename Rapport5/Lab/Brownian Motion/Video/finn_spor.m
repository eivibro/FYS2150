...
figure(1)
imagesc(a), colorbar;
dim_part_c=input('Zoom inn p� noen av partiklene i bildet og angi en typisk diameter: ','s');
dim_part=str2num(dim_part_c);
%diameteren til partikkelen b�r v�re et partall, hvis ikke gir centrd()
